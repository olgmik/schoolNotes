...
function mysql_prep($value) {
	...
	if($new_enough_php){
		//undo any magic quotes effects so my_sql_real_escape_string can do it
...
function find_selected_page(){
	// this function, when included on any page, grabs value from the current URL
	// and puts into one of the variables: $sel_page or $sel_subject
	global $sel_subject;
	global $sel_page; 
	if(isset($_GET['subj'])){
